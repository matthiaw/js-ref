# JavaScript-Reference (js-ref)

This is the trial of a JavaScript-Reference which has only JSON as data-content. The first React-Code for this reference can be found on Fiddle at https://jsfiddle.net/matthiaw/14epqeeg/.

Some working examples are placed at JSFiddle:
* [React](https://jsfiddle.net/matthiaw/bo76bfy6/show/) ([Fiddle](https://jsfiddle.net/matthiaw/bo76bfy6/))
* [React.Component](https://fiddle.jshell.net/matthiaw/zvadyoLb/show/) ([Fiddle](https://jsfiddle.net/matthiaw/zvadyoLb/))
* [React.Children](https://jsfiddle.net/matthiaw/rqxfoe2p/show/) ([Fiddle](https://jsfiddle.net/matthiaw/rqxfoe2p/))
* [React.If](https://jsfiddle.net/matthiaw/anonurs3//show/) ([Fiddle](https://jsfiddle.net/matthiaw/anonurs3/))

The React-Version of this project was bootstrapped with [Create React App](https://github.com/facebookincubator/create-react-app).

This project uses yarn and the package html-react-parser, which can be installed with yarn add html-react-parser.
